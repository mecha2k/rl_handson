...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--show-genres", action="store_true", default=False, help="Display genres stats"
    )
    parser.add_argument("--show-dials", action="store_true", default=False, help="Display dialogs")
    parser.add_argument(
        "--show-train", action="store_true", default=False, help="Display training pairs"
    )
    parser.add_argument(
        "--show-dict-freq", action="store_true", default=False, help="Display dictionary frequency"
    )
