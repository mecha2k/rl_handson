...
if __name__ == "__main__":
    ...
    if args.params == "counts":
        env = common.PseudoCountRewardWrapper(
    ...
    if args.params == "distill":
        ...
        env = common.NetworkDistillationRewardWrapper(
            env, net_distill.extra_reward, reward_scale=params.reward_scale
        )
    ...
    agent = ptan.agent.PolicyAgent(
        net.actor, apply_softmax=True, preprocessor=ptan.agent.float32_preprocessor
    )
